...
describe('Security Integration Tests', () => {
  ...
  describe('Token Refresh Security', () => {
    ...
    it('should revoke all sessions on logout-all', async () => {
      ...
      const sessionsBeforeLogout = await sessionModel.findValidByUserId(
        testUser.id
      );
      ...
      const sessionsAfterLogout = await sessionModel.findValidByUserId(
        testUser.id
      );
  ...
  describe('Input Validation Security', () => {
    ...
    it('should validate username format in profile update', async () => {
      const invalidData = {
