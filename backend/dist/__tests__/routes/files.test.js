...
describe('Files API', () => {
    ...
    beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield fs.writeFile(testFilePath, 'This is a test file for upload testing.');
    }));
    afterAll(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (uploadedFileId) {
            try {
                yield fileRecordModel.delete(uploadedFileId);
            }
            catch (error) {
                // File might not exist, ignore error
            }
        ...
        yield userModel.delete(user2.id);
    }));
    describe('POST /api/files/upload', () => {
        it('should upload file when authenticated', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect(response.body.data.message).toContain('1 file(s) uploaded successfully');
        ...
        it('should upload multiple files', () => __awaiter(void 0, void 0, void 0, function* () {
            // Create another test file
            const testFile2Path = path.join(__dirname, 'test-file-2.txt');
            yield fs.writeFile(testFile2Path, 'This is another test file.');
            const response = yield request(app)
                .post('/api/files/upload')
                .set('Authorization', `Bearer ${userToken}`)
                .attach('files', testFilePath)
                ...
                .expect(201);
            expect(response.body.success).toBe(true);
            expect(response.body.data.message).toContain('2 file(s) uploaded successfully');
            expect(response.body.data.files).toHaveLength(2);
            // Clean up
            yield fs.unlink(testFile2Path);
            for (const file of response.body.data.files) {
                yield fileRecordModel.delete(file.id);
            }
        }));
        ...
        it('should require files to be provided', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield request(app)
                .post('/api/files/upload')
                .set('Authorization', `Bearer ${userToken}`)
                .expect(400);
        ...
        it('should reject unsupported file types', () => __awaiter(void 0, void 0, void 0, function* () {
            // Create a file with unsupported extension
            const unsupportedFilePath = path.join(__dirname, 'test.exe');
            yield fs.writeFile(unsupportedFilePath, 'fake executable');
            const response = yield request(app)
                .post('/api/files/upload')
                .set('Authorization', `Bearer ${userToken}`)
                ...
                .expect(500);
            // Clean up
            yield fs.unlink(unsupportedFilePath);
        }));
    });
    describe('GET /api/files', () => {
        it('should get user files when authenticated as user', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield request(app)
                .get('/api/files')
                .set('Authorization', `Bearer ${userToken}`)
                .expect(200);
        ...
        it('should get all files when authenticated as admin', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield request(app)
                .get('/api/files')
        ...
        it('should support filtering by mimetype', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield request(app)
        ...
        it('should support filtering by file size', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield request(app)
        ...
        it('should require authentication', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield request(app).get('/api/files').expect(401);
            expect(response.body.success).toBe(false);
            expect(response.body.error.code).toBe('MISSING_TOKEN');
        }));
    });
    describe('GET /api/files/stats', () => {
        it('should get file statistics', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield request(app)
                .get('/api/files/stats')
                .set('Authorization', `Bearer ${userToken}`)
                .expect(200);
        ...
        it('should require authentication', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield request(app).get('/api/files/stats').expect(401);
            expect(response.body.success).toBe(false);
            expect(response.body.error.code).toBe('MISSING_TOKEN');
        }));
    });
    describe('GET /api/files/:id', () => {
        it('should get file metadata when user owns the file', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield request(app)
        ...
        it('should get file metadata when authenticated as admin', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield request(app)
                .get(`/api/files/${uploadedFileId}`)
                .set('Authorization', `Bearer ${adminToken}`)
                .expect(200);
        ...
        it('should deny access to other users files', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield request(app)
                .get(`/api/files/${uploadedFileId}`)
    ...
    describe('GET /api/files/:id/download', () => {
        it('should download file when user owns the file', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield request(app)
        ...
        it('should download file when authenticated as admin', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield request(app)
                .get(`/api/files/${uploadedFileId}/download`)
                .set('Authorization', `Bearer ${adminToken}`)
                .expect(200);
        ...
        it('should deny download to other users', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield request(app)
                .get(`/api/files/${uploadedFileId}/download`)
                .set('Authorization', `Bearer ${user2Token}`)
                .expect(403);
    ...
    describe('DELETE /api/files/:id', () => {
        it('should delete file when user owns the file', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const deletedFile = yield fileRecordModel.findById(fileToDeleteId);
            expect(deletedFile).toBeNull();
        }));
        it('should delete file when authenticated as admin', () => __awaiter(void 0, void 0, void 0, function* () {
            // Upload a file to delete
            const uploadResponse = yield request(app)
                .post('/api/files/upload')
                .set('Authorization', `Bearer ${userToken}`)
        ...
        it('should deny deletion to other users', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield request(app)
