...
import notificationRoutes, { clearNotifications, } from '../../routes/notifications';
const app = express();
...
describe('Notifications API', () => {
    ...
    describe('GET /api/notifications', () => {
        it('should return empty notifications initially', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield request(app).get('/api/notifications').expect(200);
            expect(response.body).toEqual({
                success: true,
                data: [],
            });
        }));
        it('should return notifications sorted by timestamp (newest first)', () => __awaiter(void 0, void 0, void 0, function* () {
            // Create two notifications
            yield request(app).post('/api/notifications').send({
                type: 'info',
        ...
        it('should filter notifications by userId', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect(response.body.data.some((n) => n.title === 'User 1 Notification')).toBe(true);
            expect(response.body.data.some((n) => n.title === 'Global Notification')).toBe(true);
            expect(response.body.data.some((n) => n.title === 'User 2 Notification')).toBe(false);
        }));
    });
    describe('POST /api/notifications', () => {
        ...
        it('should create notification with userId', () => __awaiter(void 0, void 0, void 0, function* () {
            const notificationData = {
                type: 'success',
        ...
        it('should emit notification to all clients when no userId', () => __awaiter(void 0, void 0, void 0, function* () {
            const notificationData = {
                type: 'info',
                title: 'Global Notification',
                message: 'Message for everyone',
        ...
        it('should emit notification to specific user room when userId provided', () => __awaiter(void 0, void 0, void 0, function* () {
            const notificationData = {
                type: 'info',
                title: 'User Notification',
                message: 'Message for specific user',
        ...
        it('should validate type field', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield request(app)
                .post('/api/notifications')
                .send({
                // missing type
    ...
    describe('DELETE /api/notifications/:id', () => {
        it('should delete notification', () => __awaiter(void 0, void 0, void 0, function* () {
            // Create a notification first
            const createResponse = yield request(app)
                .post('/api/notifications')
                .send({
            ...
            const getResponse = yield request(app)
    ...
    describe('POST /api/notifications/simulate', () => {
        ...
        it('should simulate notifications with default parameters', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield request(app)
                .post('/api/notifications/simulate')
                .send({})
                .expect(200);
            expect(response.body.success).toBe(true);
            expect(response.body.data.message).toBe('Simulating 1 notifications every 1000ms');
        ...
        it('should simulate multiple notifications with custom parameters', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield request(app)
                .post('/api/notifications/simulate')
                .send({
                count: 3,
                ...
                .expect(200);
            expect(response.body.success).toBe(true);
            expect(response.body.data.message).toBe('Simulating 3 notifications every 500ms');
        ...
        it('should generate different notification types', () => __awaiter(void 0, void 0, void 0, function* () {
            yield request(app)
                .post('/api/notifications/simulate')
            ...
            const types = emittedNotifications.map((n) => n.type);
            const uniqueTypes = [...new Set(types)];
            // Should have at least 2 different types (statistically likely with 10 notifications)
            expect(uniqueTypes.length).toBeGreaterThan(1);
            expect(uniqueTypes.every((type) => ['info', 'success', 'warning', 'error'].includes(type))).toBe(true);
        }));
    });
    describe('Notification data structure', () => {
        it('should create notifications with correct structure', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield request(app)
                .post('/api/notifications')
                .send({
                type: 'warning',
        ...
        it('should generate unique IDs for notifications', () => __awaiter(void 0, void 0, void 0, function* () {
            const response1 = yield request(app).post('/api/notifications').send({
                type: 'info',
                title: 'Notification 1',
                message: 'Message 1',
            });
            const response2 = yield request(app).post('/api/notifications').send({
                type: 'info',
